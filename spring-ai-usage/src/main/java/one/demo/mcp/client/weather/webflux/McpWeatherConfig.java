...
//
//    @Bean
//    public McpSyncServer mcpServer(McpServerTransportProvider transportProvider, McpWeatherService weatherService) {
...
//                .tools(McpToolUtils.toSyncToolSpecifications(ToolCallbacks.from(weatherService))) // Add @Tools
//                .build();
//
//        return server;
//    }
