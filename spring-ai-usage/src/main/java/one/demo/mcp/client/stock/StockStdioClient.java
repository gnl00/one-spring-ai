package one.demo.mcp.client.stock;
...
public class StockStdioClient {
    public static void main(String[] args) {
        SpringApplication.run(StockStdioClient.class, args);
    }
    ...
    public McpSyncClient mcpClient() {
        ...
        var stdioParams = ServerParameters.builder("java")
                .args(
                        ...
                        "-jar",
                        "/Users/gnl/workspace/code/one-spring-ai/spring-ai-mcp-server-stdio-stock-server/target/spring-ai-mcp-server-stdio-stock-server-1.0-SNAPSHOT.jar"
                )
                .build();
