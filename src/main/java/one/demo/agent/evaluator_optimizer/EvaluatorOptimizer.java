...
public class EvaluatorOptimizer {
    ...
    private RefinedResponse loop(String task, String context, List<String> memory, List<Generation> chainOfThought) {
        ...
        // Accumulated new context including the last and the previous attempts and feedbacks.
    ...
    private Generation generate(String task, String context) {
        ...
        System.out.printf("\n=== GENERATOR OUTPUT ===\nTHOUGHTS: %s\n\nRESPONSE:\n %s\n%n", generationResponse.thoughts(), generationResponse.response());
        return generationResponse;
    }

    /**
     * Evaluates if a solution meets the specified requirements and quality criteria.
     * This method represents the evaluator component of the workflow, analyzing solutions
     * and providing detailed feedback for further refinement until the desired quality level is reached.
     *
    ...
    private EvaluationResponse evaluate(String content, String task) {
        ...
        System.out.printf("\n=== EVALUATOR OUTPUT ===\nEVALUATION: %s\n\nFEEDBACK: %s\n%n", evaluationResponse.evaluation(), evaluationResponse.feedback());
